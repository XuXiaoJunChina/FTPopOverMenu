...
#define FTDefaultMenuWidth          160.0
#define FTDefaultMenuIconWidth      23.0
#define FTDefaultMenuRowHeight      43.0
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier menuName:(NSString *)menuName iconImageName:(NSString *)iconImageName
{
    ...
    if (self) {
        ...
        CGRect iconImageRect = CGRectMake(16, margin, FTDefaultMenuIconWidth, FTDefaultMenuIconWidth);
        CGRect menuNameRect = CGRectMake(CGRectGetMaxX(iconImageRect)+16, margin, FTDefaultMenuWidth - FTDefaultMenuIconWidth - margin, FTDefaultMenuIconWidth);
        if (iconImage) {
        ...
        _menuNameLabel.font = FTDefaultMenuFont;
        ...
        //移到底部
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(0, FTDefaultMenuRowHeight-0.5, FTDefaultMenuWidth, 0.5)];
        lineView.backgroundColor = [UIColor colorWithRed:214/255.0f green:215/255.0f blue:217/255.0f alpha:1];
...
//        _menuTableView.separatorColor = [UIColor redColor];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [menuCell hiddenLineView:indexPath.row == _menuStringArray.count - 1];
...
-(void)initViews
{
    ...
    if (!_popMenuView) {
#warning 2017-02-10 待接口新增参数navbar, statusbar.
        UIView *bgView2 = [[UIView alloc ]initWithFrame:CGRectMake(0, 44+20, KSCREEN_WIDTH, [UIScreen mainScreen].bounds.size.height - 44 - 20)];
        bgView2.backgroundColor = [UIColor colorWithRed:216/255 green:216/255 blue:216/255 alpha:0.1];

        [_backgroundView addSubview:bgView2];
          ...
          dismissBlock:(FTPopOverMenuDismissBlock)dismissBlock
{
    ...
    //treeview的height－searchbar高度
    if (menuHeight > (sender.superview.superview.frame.size.height - CGRectGetMaxY(sender.frame))) {
        menuHeight = sender.superview.superview.frame.size.height - CGRectGetMaxY(sender.frame);
    }
